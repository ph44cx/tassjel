...
class ShowcasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create showcase" do
    assert_difference('Showcase.count') do
      post showcases_url, params: { showcase: { body: @showcase.body, share: @showcase.share, story_image: @showcase.story_image, subtitle: @showcase.subtitle, title: @showcase.title } }
    end
  ...
  test "should update showcase" do
    patch showcase_url(@showcase), params: { showcase: { body: @showcase.body, share: @showcase.share, story_image: @showcase.story_image, subtitle: @showcase.subtitle, title: @showcase.title } }
